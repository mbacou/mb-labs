---
title: Visualizing Water 2/4
subtitle: With Sankey Diagrams
description: |
  Part 2: custom data-driven flow charts using Highcharts.js and networkD3.
date: 2021-10-01
image: _fig/sankey_truthstudio_2.gif
...
abstract: |
  This notebook is Part 2 of a code playground for hydrologic model visualization. In [Part 1](../2021-10-16-svg/) we focused on `D3.js`, here we test network and hierarchical visuals using two higher-level graphic libraries [Highchart.js](https://www.highcharts.com/) and [networkD3](http://christophergandrud.github.io/networkD3/). 
---
...
if (interactive()) {
  setwd("./posts/2021-10-12-highcharts/")
}

# Default color palette
pal = readRDS("pal_iwmi.rds")
```
...
1. TruthStudio for the Nature Conservancy's [static illustrations](https://truthstudio.com/portfolio_page/visualizing-water/) of the Colorado River basin's withdrawals and consumption.
2. [Curmi et al. 2013](https://researchgate.net/publication/257673216_Visualising_a_Stochastic_Model_of_Californian_Water_Resources_Using_Sankey_Diagrams) 
...
c(
  "./_fig/sankey_truthstudio_1.gif",
  "./_fig/sankey_truthstudio_2.gif",
  "./_fig/sankey_curmi_2013.png",
  "./_fig/sankey_lancaster.png"
) |>
  include_graphics()
```
...
data = fread(here("../2021-10-16-svg/data/data.csv"))

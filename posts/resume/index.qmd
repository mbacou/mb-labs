...
description: |
  ...
  I'm an applied economist with a focus on agricultural trade and development for both large- and small-holder farming systems. Over the years I have gained experience in policy formulation, monitoring & evaluation of ODA programs, climate risk and adaptation strategies, and in agricultural finance.
page-layout: article
...
::: {.column-margin}
![](_fig/profile.jpg){.img-rounded .d-block .mt-md-n4 width="10em"}
...
{{< bi journal-text class=text-primary >}}    [orcid.org/0000-0003-1810-6818](https://orcid.org/0000-0003-1810-6818)  
...
- Led research grants in the \$500K range, advised public agencies and private firms with large-scale data collection methods (incl. remote sensing), household survey design and analysis, market segmentation, agricultural value-chain analysis, pricing of (parametric) weather insurance.

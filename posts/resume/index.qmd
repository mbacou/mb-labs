...
author: ""
description: I am an applied economist with a focus on public sector strategies for sustainable agriculture and food security, and policy-making for equitable trade and development. 20+ years experience in program and policy design, monitoring & evaluation (M&E), climate risk assessment, and rural finance. 
...
::: {.aside}
![](_fig/profile.jpg){.img-rounded .mt-md-n5}

::: {.small .my-3}
{{< bi linkedin class=text-primary >}}    [linkedin.com/in/mbacou](https://linkedin.com/in/mbacou)\
{{< bi github class=text-primary >}}    [github.com/mbacou](https://github.com/mbacou)\
{{< bi person-circle class=text-primary >}}    [devex.com](https://www.devex.com/people/melanie-bacou-46872)\
{{< bi journal-text class=text-primary >}}    [orcid.org](https://orcid.org/0000-0003-1810-6818)  
{{< bi telegram class=text-primary >}}    [t.me/mbacou](https://t.me/mbacou)\
:::

##### <mark>Top Skills</mark>
...
- Led research grants in the \$500K range, advised public agencies and private firms with large-scale data collection methods (incl. remote sensing and mobile field surveying), household survey design and analysis, market segmentation, agricultural value-chain analysis, pricing of (parametric) weather insurance.
...
- Multidisciplinary background with ability to communicate efficiently with farmers, government officials, private sector partners, technical experts, and researchers.
...
*Databases*: MS SQL Server, MySQL, PostGIS, MongoDB, Elasticsearch, DuckDB\
*GIS*: QGIS, GRASS, GDAL, GeoServer, Mapnik, Leaflet, Kepler.gl\
*Surveying*: ODK, CSPro, SurveyCTO, Fulcrum, GISCloud, CKAN, DataHub\
*DevOps*: CentOS, Ubuntu, AWS and Azure cloud deployment and containerization, Docker\
...
::: aside
![](_fig/iwmi.jpg){width="6em" fig-align="left"}
...
::: aside
![](_fig/wc.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/bmgf.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/abt.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/ifpri.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/hc.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/agrodep.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/afdb.jpg){width="9em" fig-align="left"}
...
::: aside
![](_fig/dgf.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/gtap.png){width="8em" fig-align="left"}
...
::: aside
![](_fig/lei.jpg){width="6em" fig-align="left"}
...
::: aside
![](_fig/purdue.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/sg.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/fimatex.jpg){width="6em" fig-align="left"}
...
::: aside
![](_fig/seat.png){width="6em" fig-align="left"}
...
::: aside
![](_fig/escp.jpg){width="5em" fig-align="left"}
...
::: aside
![](_fig/llg.jpg){width="6em" fig-align="left"}

...
abstract: |
  Economist with 20+ years in public-sector consulting. Led economic development programs and research grants in the $500K range. Advised government agencies and multilateral donors with large-scale data collection methods (field-based, mobile, and remote sensing), household survey design and analysis, market segmentation, agricultural value-chain analysis, rural finance, climate risk assessment, and risk transfer.
...
::: {.aside .mt-md-5}
![](_fig/profile.jpg){width="9em" .rounded-circle}
...
<a role="button" class="btn btn-success" href="BACOU-Melanie-CV.pdf" target="_blank"><i class="bi bi-file-pdf"></i> Download PDF</a>
...
- Strong quantitative, analytical, and data modeling skills acquired in collaboration with top-rank economic research teams and consulting firms
- Multi-stakeholder (public-private) project management, fundraising, budgeting, forecasting, resource and cost tracking
- A multidisciplinary background with ability to liaise efficiently with investors, government officials, private-sector partners, technical experts, researchers, and beneficiaries
- 3+ years field experience in fragile states (Mid-East, West/subSaharan Africa)


##### Tech Skills

*Statistics* -- R, STATA, SAS, GAMS / LaTeX, Quarto, Typst\
*Survey* -- ODK, CSPro, SurveyCTO, CommCare, Fulcrum, GISCloud\
*Data viz* --  Shiny, Tableau®, Highcharts.js, D3.js, Superset, Grafana\
*GIS* -- QGIS, GRASS, GDAL, GeoServer, Carto, Mapnik, Leaflet, Kepler.gl, Google Earth Engine\
*Databases* -- MS SQL Server, MySQL, PostGIS, MongoDB, MariaDB, Elasticsearch, DuckDB\
*DevOps* -- Linux (Ubuntu, Arch), Git, CI/CD, Docker, AWS cloud deployment, containerization, orchestration (Airflow)\
...
::: aside
![](_fig/agrodep.jpg){.mt-2 width="5em"}
...
::: aside
![](_fig/purdue.jpg){.mt-2 width="5em"}
...
::: aside
![](_fig/fimatex.jpg){.mt-2 width="6em"}
...
## {{< bi journal-text >}} Publications {.mt-md-4}

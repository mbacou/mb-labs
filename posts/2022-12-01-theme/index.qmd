...
As of writing, Quarto (and/or Thematic) won't automatically apply Bootstrap branding elements to dynamic graphics. Instead I defined my own utility functions in a separate `mblabs` R package.

```{r}
#| filename: ./R/theme.R
#| code-fold: true
#| code-summary: "Show function"
#| echo: !expr mblabs::brand.colors
...
#| code-fold: true
#| code-summary: "Show function"
#| echo: !expr mblabs::scale_brand_dc
...
These graphic customizations are documented in my [mblabs](https://mbacou.github.io/mblabs/) R package. This helps with handling dependencies, with code reproducibility, and because I want to use themes more flexibly across projects and clients.

```{r}
#| filename: ./R/theme.R
#| code-fold: true
#| code-summary: "Show function"
#| echo: !expr mblabs::theme_brand
...
b1 <- brand_theme(
  file="../../assets/scss/_brand.yml", 
  fg="gray", bg="light", accent=c("dark", "teal"), font="monospace",
...
b2 <- brand_theme(
  file="../../assets/scss/_brand.yml", 
  fg="gray", bg="light", font="headings")
...
thematic::thematic_set_theme(brand_theme(
  fg="gray", bg="light", accent="teal", font="m"))

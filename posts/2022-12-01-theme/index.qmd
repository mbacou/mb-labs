...
::: {.aside .description .mt-md-2}
No other reason for this map but to showcase Quarto's new content layout features -- I am a fan of Soviet-era classic topo styles. Check out Russian [cartography](https://sovietmaps.com/), it is stunning work.

This margin note uses `<div class="aside description">` making use of both Quarto and Boostrap's CSS utilities.
...
[^1]: For folks born this century, to **babel** (elips) or to **sweave** (R) is the process of compiling text documents that include both static markup and compile-time executable scripts.
    ...
    ![](_fig/Donald-Knuth.jpg){.img-rounded .d-block .mx-auto}
    ...
    ![](_fig/Carsten-Dominik.jpg){.img-rounded .d-block .mx-auto}
...
#| filename: ./assets/scss/_theme.scss
#| echo: !expr c(60:86)
...
ggplot(faithfuld, aes(waiting, eruptions, z = density), grid = "XY") +

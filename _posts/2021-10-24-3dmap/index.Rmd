...
base_map <- srtm_array %>% 
  ...
  add_water(detect_water(srtm_water), color=alpha(pal["blue"], 0.8))

saveRDS(base_map, "./_data/base_map.rds")

```

```{r, fig.cap="Step 1 - Hillshade Basemap of Selingue Dam"}
...
```{r, fig.cap="Interactive 3D Scene of Selingue Dam"}

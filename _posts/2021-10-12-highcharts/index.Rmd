...
This notebook is Part 2 of a code playground for hydrologic model visualization. In [Part 1](../2021-10-16-svg/) we focused on `D3.js`, here we test network and hierarchical visuals using a higher-level graphic library `Highchart.js`.

`Highcharts` is built on top of D3 but comes with sample configurations and R and Python clients, making it easier to build dynamic charts, esp. Sankey, treemaps, and flow diagrams with significantly less code.

This approach is inspired by:

1. [Curmi et al. 2013](https://www.researchgate.net/publication/257673216_Visualising_a_Stochastic_Model_of_Californian_Water_Resources_Using_Sankey_Diagrams) 
2. Lancaster University [Food-Energy Flows](https://github.com/csaladenes/food-energy-flows) diagram
3. TruthStudio for the Nature Conservancy's [static illustrations](https://www.truthstudio.com/portfolio_page/visualizing-water/) of the Colorado River basin's withdrawals and consumption.

```{r, out.width="50%", fig.width=3, fig.show="hold"}

c(
  "../../www/fig/sankey_truthstudio_1.gif",
  "../../www/fig/sankey_truthstudio_2.gif",  
  "../../www/fig/sankey_curmi_2013.png",
  "../../www/fig/sankey_lancaster.png"
) %>%
  include_graphics()
...
data <- fread("../2021-10-16-svg/data.csv")

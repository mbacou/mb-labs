...
preview: ../../www/svg/sheet_1_edited.svg
categories:
  - draft
  - imwi
  - hydrology
...
knitr::include_graphics(svg[-c(1:3, 7, 9)])
...
htmltools::tags$script(src="https://cdn.jsdelivr.net/npm/d3-array@3")
```
...
> Note: make sure to remove attributes `<svg width="" height="">` from the SVG file produced by Inkscape.
...
<button onclick="fun_reset('../../www/svg/sheet_1_edited.svg', 'd3ex3');">Reset Design</button>
:::
...
fun_reset("../../www/svg/sheet_1_edited.svg", "d3ex3");
...
When bound with the yearly model simulation, the widget now behaves as follows (src: [shinyapps.io](https://mbacou.shinyapps.io/iwmi_app/)).


<iframe src="https://mbacou.shinyapps.io/iwmi_app/" height="640" width="100%" style="border:none;">

...
Now that we have the SVG DOM loaded, we can do silly things, like change the text color or move (translate) some elements. We can also list all text elements with default value "NaN", so that we can start mapping text labels to data values.
